      ...
      <div className="mx-auto w-full max-w-[520px]">
        <div className="animate-float-up opacity-0" style={{ animationDelay: "0ms" }}>
          ...
          >
            ...
            <h1 className="mt-1.5 flex flex-col items-center gap-1.5">
              <img
                src={headingCreate}
                alt="Create"
                className="h-auto w-[clamp(150px,42vw,190px)] object-contain"
                draggable={false}
              />
              <img
                src={headingPlayableWorlds}
                alt="Playable Worlds"
                className="h-auto w-[clamp(170px,48vw,215px)] object-contain"
                draggable={false}
              />
            </h1>
